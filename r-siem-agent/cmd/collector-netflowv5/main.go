...
import (
	...
	"r-siem-agent/internal/collector/netflowv5"
...
func main() {
	configPath := flag.String("config", "configs/collector-netflowv5.yaml", "Path to collector config")
	flag.Parse()
	...
	nc, err := nats.Connect(cfg.JetStream.URL, nats.Name("r-siem-collector-netflowv5"))
	if err != nil {
	...
	collector := netflowv5.New(netflowv5.Config{
